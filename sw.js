...
const CACHE_VERSION = 'v97-2026-05-17-back-button-modals-v83';
...
const PRECACHE_URLS = [
  ...
  '/path.html',
  '/profile.html',
  '/src/styles/main.css?v=79',
  '/src/styles/desktop.css?v=79',
  '/certifications/',
  '/src/styles/path.css?v=79',
  '/src/styles/profile.css?v=79',
  '/src/cq-core.js?v=79',
  '/src/path.js?v=79',
  '/src/profile.js?v=79',
  '/src/mascot-loader.js?v=79',
  '/src/pack-picker.js?v=79',
  '/src/auth.js?v=79',
  '/src/auth-ui.js?v=79',
  '/src/sync.js?v=79',
  '/src/reset-password.js?v=79',
  '/data/cosmetics.json',
