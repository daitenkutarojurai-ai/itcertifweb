...
const CACHE_VERSION = 'v104-2026-05-18-hamburger-1023px-v90';
...
const PRECACHE_URLS = [
  ...
  '/path.html',
  '/profile.html',
  '/src/styles/main.css?v=90',
  '/src/styles/desktop.css?v=90',
  '/src/styles/home-mobile.css?v=90',
  '/certifications/',
  '/src/styles/path.css?v=90',
  '/src/styles/profile.css?v=90',
  '/src/cq-core.js?v=90',
  '/src/path.js?v=90',
  '/src/profile.js?v=90',
  '/src/mascot-loader.js?v=90',
  '/src/pack-picker.js?v=90',
  '/src/auth.js?v=90',
  '/src/auth-ui.js?v=90',
  '/src/sync.js?v=90',
  '/src/reset-password.js?v=90',
  '/data/cosmetics.json',
