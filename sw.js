...
const CACHE_VERSION = 'v73-2026-05-13-phase5-7-session-hud-v59';
...
const PRECACHE_URLS = [
  ...
  '/path.html',
  '/profile.html',
  '/src/styles/main.css?v=59',
  '/src/styles/desktop.css?v=59',
  '/certifications/',
  '/src/styles/path.css?v=59',
  '/src/styles/profile.css?v=59',
  '/src/cq-core.js?v=59',
  '/src/path.js?v=59',
  '/src/profile.js?v=59',
  '/src/mascot-loader.js?v=59',
  '/src/auth.js?v=59',
  '/src/auth-ui.js?v=59',
  '/src/sync.js?v=59',
  '/src/reset-password.js?v=59',
  '/data/cosmetics.json',
