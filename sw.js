...
const CACHE_VERSION = 'v60-2026-05-12-phase3d-profile-account-v46';
...
const PRECACHE_URLS = [
  ...
  '/path.html',
  '/profile.html',
  '/src/styles/main.css?v=46',
  '/src/styles/desktop.css?v=46',
  '/certifications/',
  '/src/styles/path.css?v=46',
  '/src/styles/profile.css?v=46',
  '/src/cq-core.js?v=46',
  '/src/path.js?v=46',
  '/src/profile.js?v=46',
  '/src/mascot-loader.js?v=46',
  '/src/auth.js?v=46',
  '/src/auth-ui.js?v=46',
  '/src/sync.js?v=46',
  '/data/cosmetics.json',
