...
const CACHE_VERSION = 'v107-2026-05-20-mobile-header-v93';
...
const PRECACHE_URLS = [
  ...
  '/path.html',
  '/profile.html',
  '/src/styles/main.css?v=93',
  '/src/styles/desktop.css?v=93',
  '/src/styles/home-mobile.css?v=93',
  '/certifications/',
  '/src/styles/path.css?v=93',
  '/src/styles/profile.css?v=93',
  '/src/cq-core.js?v=93',
  '/src/path.js?v=93',
  '/src/profile.js?v=93',
  '/src/mascot-loader.js?v=93',
  '/src/pack-picker.js?v=93',
  '/src/auth.js?v=93',
  '/src/auth-ui.js?v=93',
  '/src/sync.js?v=93',
  '/src/reset-password.js?v=93',
  '/data/cosmetics.json',
